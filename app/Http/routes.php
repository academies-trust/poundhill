...
Route::get('about/vision', 'HomeController@vision');
Route::get('about/our-day', 'HomeController@ourday');
...
Route::get('community/coco', 'HomeController@coco');
Route::get('partners/partners', 'HomeController@partners');
Route::get('partners/parents', 'HomeController@parents');
Route::get('partners/friends', 'HomeController@friends');
Route::get('partners/schoolmeeting', 'HomeController@schoolmeeting');
...
Route::get('parents/termdates', 'HomeController@termdates');
Route::get('parents/support', 'HomeController@support');
Route::get('parents/letters', 'HomeController@letters');
Route::get('parents/uniform', 'HomeController@uniform');
Route::get('news/events', 'HomeController@events');
Route::get('parents/food-and-drink', 'HomeController@foodanddrink');
