			...
			<div class="col-md-12">
				<header>
					<div>
						...
						<h1>Sports News</h1>
						<a href="{{url()}}/about/news"><btn class="btn btn-default"><span class="glyphicon glyphicon-backward logo text-blue"></span>back to sports news</btn></a>
					</div>
				</header>
				<div class="grey-container padding-x2">
					<span class="h4 bg-white padding-x1 pull-right">published {{$difference = ($update->published_on->diff($now)->days < 1) ? 'today' : $update->published_on->diffForHumans()}}</span>
