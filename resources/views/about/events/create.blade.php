			...
			<div class="col-md-12">
				...
				{!!Form::open(['url' => 'about/news', 'files'=>true])!!}
					...
					<div class="form-group">
						...
						<input type="text" id="headline" name="headline" class="form-control" placeholder="Brief synopsis of event" maxlength="150" >
					</div>
					<div class="form-group">
						<label for="body">Content</label>
						<textarea id="body" name="body" required class="form-control" placeholder="Event details" ></textarea>
					</div>
					<div class="form-group">
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="published">Event On</label>
							<input type="text" required id="published" name="published" class="form-control" placeholder="Event Date">
						</div>
						<div class="form-group col-md-6">
							<label for="expires">Event Until (optional)</label>
							<input type="text" required id="expires" name="expires" class="form-control" placeholder="Event Ends">
						</div>
					</div>
