			...
			<div class="col-md-12">
				...
				{!!Form::open(['url' => 'about/news', 'files'=>true])!!}
					<div class="form-group">
						...
						<input type="text" id="title" name="title" class="form-control" placeholder="Title of item of news" required >
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea id="body" name="body" required class="form-control" placeholder="News item content here" ></textarea>
					</div>
					<div class="form-group">
