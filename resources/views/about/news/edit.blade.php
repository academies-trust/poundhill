	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<header>
					<h1>News - Edit</h1>
					<a href="{{url('about/news').'/'.$update->id}}">back to News</a>
				</header>
				{!!Form::open(['url' => 'about/news/'.$update->id,'files'=>true, 'method' => 'PATCH'])!!}
					<div class="form-group">
						<label for="title">Title</label>
						<input type="text" id="title" name="title" class="form-control" placeholder="Title of item of news" required value="{{$update->title}}">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea id="body" name="body" required class="form-control" placeholder="News item content here" >{{$update->content}}</textarea>
					</div>
					<div class="form-group">
